...
const BUNDLE_ID = 'com.renomi.contacts'; // ios bundle id
const PACKAGE = 'com.renomi.contacts'; // android package name
const NAME = 'Contacts'; // app name
...
const _clientEnv = {
  ...
  API_URL:
    APP_ENV !== 'production' ? process.env.API_URL : process.env.PROD_API_URL,
};
